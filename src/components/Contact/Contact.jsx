...
const Contact = ({ onCancel, fetchContact }) => {
...
const handleSubmit = async () => {
  try {
    const response = await fetch('https://test.pearl-developer.com/lottery/public/api/contact-us', {
      method: "POST",
      headers: {
    ...
    if (response.ok && result.status) {
      ...
      alert("Failed to create contact: " + result.message);
    }
  } catch (error) {
